...
| `completion-experiments/<your-method>` | TBD | `extraction-v2-reviewed` | Your new completion method (e.g. ANN + classifier). Adds `LINTAS_BUKU_*` edges. | TBD | TBD | Slug must identify the method (e.g. `ann-classifier-v1`, `llm-emit-v2`). |
